...
export function sjabloonVoorKaalPad(pad) {
  ...
  // Een sjabloonstring is geen pad. `/products/[handle]` matcht namelijk zélf op
  // /products/[^/]+, dus zonder deze regel kan een aangepaste client zijn eigen
  // sjabloon insturen en daarmee de allowlist omzeilen — precies wat er in de
  // rooktest op productie gebeurde met /bestelling/GN-99999. Echte URL's die wij
  // serveren bevatten geen blote blokhaken.
