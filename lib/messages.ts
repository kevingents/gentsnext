...
const nl: Dict = {
  ...
  "myStore.choose": "Kies je winkel(s)",
  "myStore.chooseCta": "Kiezen",
  "myStore.change": "Winkels wijzigen",
  "myStore.explain": "Je ziet dan bij elk artikel of het in jouw winkels ligt, en je kunt erop filteren.",
  "myStore.explainShort": "Je ziet per maat of het er ligt.",
  "myStore.locator.current": "Jouw winkel:",
  "myStore.locator.currentPlural": "Jouw winkels:",
  "myStore.locator.pickTitle": "Kies je vaste winkel(s).",
  "myStore.locator.pickBody": "Dan zie je bij elk artikel meteen of het daar ligt — en kun je de collectie filteren op wat er in die winkels hangt.",
  "myStore.max": "Maximaal {count} winkels.",
  "myStore.km": "{km} km",
  "myStore.done": "Klaar",
  "myStore.countLabel": "{first} +{count}",
  "myStore.elsewhereFull": "Wel op voorraad in {count} andere winkels.",
  ...
  "account.prefs.store": "Mijn winkels",
  "account.prefs.storeHint": "We tonen dan overal of een artikel in één van die winkels ligt.",
...
const en: Dict = {
  ...
  "myStore.choose": "Choose your store(s)",
  "myStore.chooseCta": "Choose",
  "myStore.change": "Change stores",
  "myStore.explain": "You'll then see on every item whether it's in your stores — and you can filter on it.",
  "myStore.explainShort": "You'll see per size whether it's there.",
  "myStore.locator.current": "Your store:",
  "myStore.locator.currentPlural": "Your stores:",
  "myStore.locator.pickTitle": "Pick your regular store(s).",
  "myStore.locator.pickBody": "You'll then see on every item whether it's there — and you can filter the collection by what's hanging in those stores.",
  "myStore.max": "Up to {count} stores.",
  "myStore.km": "{km} km",
  "myStore.done": "Done",
  "myStore.countLabel": "{first} +{count}",
  "myStore.elsewhereFull": "In stock at {count} other stores.",
