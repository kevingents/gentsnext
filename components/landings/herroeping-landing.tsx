 ...
 */
export function HerroepingLanding() {
  return (
    <div className="mx-auto max-w-2xl px-gutter py-12">
      <p className="label-brand">Herroepingsrecht</p>
      <h1 className="mt-2 text-display-md">Modelformulier voor herroeping</h1>
      ...
      <div className="mt-8 rounded-card border border-line p-6 font-sans text-sm leading-relaxed text-ink">
        ...
        <dl className="mt-5 space-y-4">
          <div>
            <dt className="font-medium">Aan</dt>
          ...
          <div>
            <dt className="font-medium">Mededeling</dt>
          ...
          <div>
            <dt className="font-medium">Handtekening</dt>
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        <Link href="/pages/retourneren" className="btn-primary">Naar het retourportaal</Link>
